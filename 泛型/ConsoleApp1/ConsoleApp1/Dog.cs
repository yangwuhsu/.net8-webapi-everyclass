...
public class Dog:Animal,IEat
{
    ...
    public string FavoriteFood { get => Food; set => Food=value; }
    ...
    public new string Eat() => base.Eat();

    public string Move(string way = "east", int moves = 1) => $"dog {Name} moves {moves} in {way}";
}
